-- Rackd cloud schema — INCREMENTAL bundle: time clock.
-- Apply after deploy-029.sql. Idempotent; paste into the Supabase SQL editor and Run.

-- ==================== supabase/migrations/030_time_clock.sql ====================
-- 030_time_clock.sql
