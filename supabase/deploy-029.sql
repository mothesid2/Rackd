-- Rackd cloud schema — INCREMENTAL bundle: security/permissions layer (Phase A).
-- Apply after deploy-028.sql. employees + permissions mirrors + append-only override log.

-- ==================== supabase/migrations/029_permissions.sql ====================
-- 029_permissions.sql
