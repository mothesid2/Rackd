-- Rackd cloud schema — INCREMENTAL bundle: Phase 3 (shared customer book).
-- Apply after deploy-018.sql. Idempotent; paste into the Supabase SQL editor and Run.

-- ==================== supabase/migrations/019_customers_shared_identity.sql ====================
