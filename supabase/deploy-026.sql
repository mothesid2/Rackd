-- Rackd cloud schema — INCREMENTAL bundle: rebate schedule (Part 4).
-- Apply after deploy-025.sql. Seeds manufacturers per tenant + Vault reader + pg_cron.

-- ==================== supabase/migrations/026_rebate_schedule.sql ====================
