-- Rackd cloud schema — INCREMENTAL bundle: Phase 6 (manager portal).
-- Apply after deploy-020.sql. Idempotent; paste into the Supabase SQL editor and Run.

-- ==================== supabase/migrations/021_manager_portal.sql ====================
