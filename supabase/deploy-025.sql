-- Rackd cloud schema — INCREMENTAL bundle: manufacturer rebates (Part 1 schema).
-- Apply after deploy-024.sql. Idempotent; paste into the Supabase SQL editor and Run.
-- NOTE: uses is_manager()/current_tenant_id()/current_location_id() from earlier migrations.

-- ==================== supabase/migrations/025_rebates.sql ====================
-- 025_rebates.sql
