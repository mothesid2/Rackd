...
// Body: Instrument Sans (clean, a touch of warmth).
        ...
        <CartProvider>
          <header className="sticky top-0 z-30 bg-char text-white">
            <div className="max-w-3xl mx-auto flex items-center gap-3 px-4 h-16">
              ...
              <Link
                href="/"
                className="ml-1 inline-flex items-center gap-1.5 rounded-full bg-accent hover:bg-ember transition-colors text-white text-sm font-semibold pl-3.5 pr-4 py-2"
              >
