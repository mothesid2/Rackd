/*
 * Sync worker demo — exercises the offline-safe logic (policy, enqueue
 * filtering, dead-letter progression, status logging) against a throwaway DB.
 * The live cloud push isn't run here (Supabase is dormant with placeholder
 * creds); this shows the deterministic local behavior.
 *   npx electron scripts/sync-demo.js
 */
const os = require('os');
const fs = require('fs');
