/*
 * STEP 1 demo — enqueueLocalRow producer: atomic enqueue with tenant_id
 * injection, and the no-op-when-unconfigured guard. Against a throwaway DB.
 *   npx electron scripts/step1-demo.js
 */
const os = require('os');
const fs = require('fs');
...
// Cache a license so getTenantId() resolves.
