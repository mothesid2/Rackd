...
// "Use it or lose it" — zero out points for customers inactive beyond the
// configured window. Returns how many customers were expired.
...
export function registerLoyaltyHandlers(): void {
  ...
  // Text opted-in customers who are within N points of their next reward.
